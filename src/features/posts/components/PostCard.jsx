function PostCard({ post, onEdit, deleteMutation, onOpenComments }) {
  return (
    <article className="w-full max-w-sm rounded-xl border border-slate-200 bg-white p-5 shadow-sm mb-5 transition hover:-translate-y-1 hover:shadow-lg">
